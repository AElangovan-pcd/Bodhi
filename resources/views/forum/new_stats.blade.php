...
@section('content')
    ...
    <script type="text/javascript">
        ...
        ractive.on("tsv", function(event) {
			...
			var tsv = "First Name\tLast Name\tSeat\tEmail\t";
            ...
            for (var i = 0; i < students.length; i++) {
				...
				tsv += students[i].seat + "\t";
                tsv += students[i].email + "\t";
                tsv += students[i].forum_views_count + "\t" + students[i].forums_count + "\t" + students[i].forum_answers_count + "\t" + students[i].forum_votes_count + "\t" + students[i].forum_helpful_answers_count + "\t" + students[i].forum_helpful_votes_count + "\t" + students[i].forum_endorsed_answers_count;
				tsv+= "\n";
            }
