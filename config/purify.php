...
use function Illuminate\Support\Facades\storage_path;
    ...
    */
    ...
    'settings' => [
        ...
        */
        ...
        'Cache.SerializerPath' => \Illuminate\Support\Facades\Storage::path('purify'),
        ...
        */
        ...
        'HTML.Allowed' => 'div,h1,h2,h3,h4,h5,h6,sub,sup,b,strong,i,em,a[href|title],ul,ol,li,p[style],br,span[style],img[width|height|alt|src],table[border|cellspacing|cellpadding|width|summary|style],tr,tbody,td[abbr|colspan|rowspan|align|valign],th[abbr|colspan|rowspan|align|valign]',
